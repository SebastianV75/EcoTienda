...
export const SOLAR_PANEL_TEMPLATE: ServiceTemplate = {
	...
	items: [
		{
			product_name: "6 paneles solares inversor de 3 kw",
			quantity: 1,
			unit_price:
				REFERENCE_PRICES.PANEL_SOLAR_550W * 6 + REFERENCE_PRICES.INVERSOR_3KW,
		},
		{
		...
		{
			product_name: "Aumento de cableado electrico paneles solares",
			quantity: 1,
			unit_price: 2500,
		},
	],
...
export const MINISPLIT_1TON_TEMPLATE: ServiceTemplate = {
	...
	items: [
		{
			product_name: "Minisplit 1 ton inverter",
			quantity: 1,
			unit_price: REFERENCE_PRICES.MINISPLIT_1TON_INVERTER,
		},
		{
			product_name: "Instalacion de minisplit 1 ton",
			quantity: 1,
			unit_price: REFERENCE_PRICES.INSTALACION_MINISPLIT_1TON,
		},
		{
...
export const MINISPLIT_2TON_TEMPLATE: ServiceTemplate = {
	...
	items: [
		{
			product_name: "Minisplit 2 ton inverter",
			quantity: 1,
			unit_price: REFERENCE_PRICES.MINISPLIT_2TON_INVERTER,
		},
		{
			product_name: "Instalacion de minisplit 2 ton",
			quantity: 1,
			unit_price: REFERENCE_PRICES.INSTALACION_MINISPLIT_2TON,
		},
		{
			product_name: "Base de minisplit",
			quantity: 1,
...
export const SOLAR_PUMP_TEMPLATE: ServiceTemplate = {
	...
	items: [
		{
			product_name: "Motobomba sumergible kolos2spp / 2 paneles/estructura",
			quantity: 1,
			unit_price: REFERENCE_PRICES.BOMBA_SUMERGIBLE_180W,
		},
		{
			product_name: "Acometida 220 v",
			quantity: 1,
...
export const SOLAR_AMPLIATION_TEMPLATE: ServiceTemplate = {
	...
	items: [
		{
			product_name: "Panel solar 550w ampliacion",
			quantity: 4,
			unit_price: REFERENCE_PRICES.PANEL_SOLAR_550W,
		},
		{
 ...
 */
export function templateToQuotationItems(
