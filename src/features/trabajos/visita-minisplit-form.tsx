...
import {
	saveVisitaMinisplitAction,
	type VisitaMinisplitActionState,
} from "./visita-minisplit-actions";

type VisitaMinisplitFormProps = {
	trabajoId: string;
};

const initialState: VisitaMinisplitActionState = {
	error: null,
	success: null,
};
...
export function VisitaMinisplitForm({ trabajoId }: VisitaMinisplitFormProps) {
