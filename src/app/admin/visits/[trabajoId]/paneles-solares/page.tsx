...
import { PanelesSolaresForm } from "@/features/trabajos/paneles-solares-form";

export default async function PanelesSolaresPage({
	params,
}: {
		...
		>
			<div className="space-y-4">
					...
					<div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
						<div className="min-w-0">
							...
							<p className="mt-3 max-w-3xl text-sm leading-6 text-[var(--muted)]">
								Completa el formulario de visita técnica para paneles solares.
							</p>
						</div>
				...
				<section className="rounded-[24px] border border-[var(--border-soft)] bg-white p-5 shadow-sm sm:p-6">
					<PanelesSolaresForm trabajoId={trabajoId} />
				</section>
			</div>
		</AppShell>
	);
