...
import { Cambio220Form } from "@/features/trabajos/cambio-220-form";

export default async function Cambio220Page({
	params,
}: {
		...
		>
			<div className="space-y-4">
					...
					<div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
						<div className="min-w-0">
							...
							<p className="mt-3 max-w-3xl text-sm leading-6 text-[var(--muted)]">
								Completa el formulario de visita técnica para cambio a 220.
							</p>
						</div>
				...
				<section className="rounded-[24px] border border-[var(--border-soft)] bg-white p-5 shadow-sm sm:p-6">
					<Cambio220Form trabajoId={trabajoId} />
				</section>
			</div>
		</AppShell>
	);
